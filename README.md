...
![Known Vulnerabilities](https://snyk.io/test/github/hm400/technitium-docker-build/badge.svg?targetFile=Dockerfile)

#(https://snyk.io/test/github/hm400/technitium-docker-build?targetFile=Dockerfile)
